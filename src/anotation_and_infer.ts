...
let firstname: string = "Naetik"; // this is anotating
...
function greet(name: string): string { // so here we are saying that the type of name should be string and this function should return a value string only
